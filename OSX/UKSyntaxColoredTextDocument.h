...
//
//	sumiisan ss130509 made some variable-type modification to fit OS10.7 (for example int to NSInteger)
//
...
struct SelectionRange
{
	...
	NSInteger	startRange; // start of selection range (if line < 0)
	NSInteger	endRange;   // end of selection range (if line < 0)
